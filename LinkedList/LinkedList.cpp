...
int main() {
    ...
    struct stud* student1 = createStudent(1, "Kaushik", 19);
    struct stud* student2 = createStudent(2, "Aman", 20);
    struct stud* student3 = createStudent(3, "Arsalan", 19);
    struct stud* student4 = createStudent(4, "Udit", 21);
